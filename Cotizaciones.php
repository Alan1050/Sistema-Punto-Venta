...
if (isset($_POST['agregar'])) {
    ...
    if ($query) {
        ...
        if ($row = mysqli_fetch_assoc($query)) {
            ...
            $_SESSION['DescripC'] = '';
            $_SESSION['MarcaC'] = '';
            echo "<script> window.location.href = 'Cotizaciones.php'; </script>";
        } else {
...
if (isset($_POST['RealizarVenta'])) {
    ...
    $Nom = $_SESSION['nombre'];
    $insertarVenta = "INSERT INTO cotizaciones (NombreEmpleado, Descripcion, Folio, Total_Pagar) VALUES ('$Nom', '$Descripcion', '$Folio', '$totalAPagar')";
    ...
    echo '<script>
        alert("Cotizacion Realizada con Éxito con el Folio: ' . $Folio . '");
    ...
    <section>
        <div>
            ...
            <div>
                    ...
                    if ($query30 && mysqli_num_rows($query30) > 0) {
                        if (mysqli_num_rows($query30) > 1) {
                            ...
                            <form action="" method="post" class="For1">
                                ...
                                <h3>Cuantos Se Cotizara: </h3> <input type="number" name="cantidad"><br>
                ...
                ?>
                        <form action="Cotizaciones.php" method="post" class="For1">
                            <h1>Informacion del Producto:</h1>
                            <?php
        ...
        <div>
                ...
                <tbody>
                    <?php if (isset($_SESSION['carrito']) && count($_SESSION['carrito']) > 0): ?>
                        <?php foreach ($_SESSION['carrito'] as $producto): $IP = $producto['id']; ?>
                            <tr>
                                <form action="Cotizaciones.php?ID=<?php echo $IP; ?>" method="post">
            ...
            <form action="" method="post">
                <button type="submit" name="RealizarVenta"><img src="img/caja-registradora.png" alt=""><br>Realizar Cotizacion</button>
            </form>
        </div>
    </section>
</body>
