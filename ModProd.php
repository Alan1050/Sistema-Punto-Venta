...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['Guardar'])) {
        ...
        if (!empty($CodBarrasNew) && !empty($Des) && !empty($Presentacion) && !empty($Marcas) && !empty($Lineas) && !empty($CodigoProducto) && !empty($CodigoProducto)) {
...
<header>
    ...
    <div class="">
        <ul>
            <li><a href="ListaProducto.php">Volver</a></li>
